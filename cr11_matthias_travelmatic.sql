...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Jul 2019 um 16:40
...
--
-- Datenbank: `cr11_matthias_travelmatic`
--
...
--
-- Tabellenstruktur für Tabelle `locationcon`
--
...
--
-- Tabellenstruktur für Tabelle `locationrest`
--
...
--
-- Daten für Tabelle `locationrest`
--
...
--
-- Tabellenstruktur für Tabelle `locationtodo`
--
...
--
-- Daten für Tabelle `locationtodo`
--
...
(2, 'admin', 'admin@admin.com', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', NULL, NULL, NULL, 'admin'),
(3, 'user', 'user@user.com', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', NULL, NULL, NULL, 'user');
...
--
-- Indizes für die Tabelle `locationcon`
--
ALTER TABLE `locationcon`
  ADD PRIMARY KEY (`locCon_id`);

--
-- Indizes für die Tabelle `locationrest`
--
ALTER TABLE `locationrest`
  ADD PRIMARY KEY (`locRest_id`);

--
-- Indizes für die Tabelle `locationtodo`
--
